...
function index() {
  return (
    <div className='re-container'>
      ...
      />
      <div className='row justify-content-md-between align-items-lg-center'>
        <div className='float-md-start col-md-4 col-sm-12 mb-2'>
        ...
        <div className='col-md-4 col-sm-12 mb-2'>
          <div className='kanan text-center float-md-end'>
            Copyright © 2021 <strong>Koendang.in</strong>
          </div>
        </div>
      </div>
    </div>
